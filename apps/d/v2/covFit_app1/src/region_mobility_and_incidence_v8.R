...
region_mobility_and_incidence_v8 <- function(inputs) {
  # 
  with(inputs,{
    if (Country.Region=="US" & Province.State != "") {US_TF <- T} else {US_TF <- F}
    if (US_TF) {
      incidence_frame <- jhu_covid_get_region_incidence_US_v3(covid19_US,
                                                              covid19_deaths_US,
                                                              start_date,
                                                              Province.State,
                                                              Admin2,
      ...
      incidence_frame <- jhu_covid_get_region_incidence_2(covid19,
                                                          covid19_deaths_US,
                                                          start_date,
                                                          Country.Region,
